...
Change user's Multi-Assets mode (Multi-Assets Mode or Single-Asset Mode) on **_Every symbol_**
...
Get user's Multi-Assets mode (Multi-Assets Mode or Single-Asset Mode) on **_Every symbol_**
